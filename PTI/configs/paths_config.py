...
local_repo_path = 'C:/personal/Technion/pain-GAN/PTI'

## Pretrained models paths
e4e = './pretrained_models/e4e_ffhq_encode.pt'
stylegan2_ada_ffhq = os.path.join(local_repo_path, 'pretrained_models/ffhq.pkl')
